...
<body>
                ...
                <div class="col-md-12">
                    <nav class="navbar navbar-default">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand dis-none" href="index-2.html"><img src="{{asset('frontend/img/logo-black.png')}}" alt="">
                                </a>
                            <a class="navbar-brand dis-block" href="index-2.html"><img src="{{asset('frontend/img/logo-black.png')}}" alt="">
                                </a>
                        </div>
    ...
    <div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                <!-- Slide Background -->
                <img src="{{asset('frontend/img/bg/3.jpg')}}" alt="Slider Images"  class="slide-image"/>
            ...
            <div class="item">            
                <!-- Slide Background -->
                <img src="{{asset('frontend/img/bg/2.jpg')}}" alt="Slider Images" class="slide-image"/>
                <div class="bs-slider-overlay"></div>
                <!-- Slide Text Layer -->
            ...
            <div class="item">            
                <!-- Slide Background -->
                <img src="{{asset('frontend/img/bg/1.jpg')}}" alt="Slider Images"  class="slide-image"/>
                <div class="bs-slider-overlay"></div>
                <!-- Slide Text Layer -->
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="row margin-top-20">
                            <div class="col-md-6">
                                <img class="margin-top-10" src="{{asset('frontend/img/services/s1.jpg')}}" alt="">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-5">
                        <div>
                           <img alt="" src="{{asset('frontend/img/services/w1.jpg')}}"> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-content">
                <div class="row clearfix">
                    ...
                    <div class="gallery col-3 gutter">
                                ...
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{asset('frontend/img/portfolio/1.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{asset('frontend/img/portfolio/1.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                        ...
                        <div class="gallery-item gp-three">
                            <div class="thumb">
                                ...
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{{asset('frontend/img/portfolio/2.jpg')}}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{asset('frontend/img/portfolio/2.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gallery-item gp-four">
                            <div class="thumb">
                                ...
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{asset('frontend/img/portfolio/3.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{asset('frontend/img/portfolio/3.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gallery-item gp-five">
                            <div class="thumb">
                                ...
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{asset('frontend/img/portfolio/4.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{asset('frontend/img/portfolio/4.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gallery-item gp-two">
                            <div class="thumb">
                                ...
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{asset('frontend/img/portfolio/5.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{asset('frontend/img/portfolio/5.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gallery-item gp-three">
                            <div class="thumb">
                                <img src="{{asset('frontend/img/portfolio/6.jpg')}}" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{asset('frontend/img/portfolio/6.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{asset('frontend/img/portfolio/6.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
   ...
   <!-- divider start -->
    <section class="divider divider-video over-layer-white" style="background-image:url({{asset('frontend/img/bg/6.jpg')}});">
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="{{asset('frontend/practice-img')}}">
                                <a href="#">
                                    <img src="{{asset('frontend/img/services/4.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="{{asset('frontend/practice-img')}}">
                                <a href="#">
                                    <img src="{{asset('frontend/img/services/5.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                            <div class="practice-content">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="{{asset('frontend/practice-img')}}">
                                <a href="#">
                                    <img src="{{asset('frontend/img/services/6.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                            <div class="practice-content">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="{{asset('frontend/practice-img')}}">
                                <a href="#">
                                    <img src="{{asset('frontend/img/services/8.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                            <div class="practice-content">
    ...
    <section class=" animatedParent animateOnce">
        <div class="container padding-bottom-none">
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <img class="animated fadeInLeftShort slow delay-500 booking-cantact-img" src="{{asset('frontend/img/bg/c1.png')}}" alt="">
                    </div>
                        ...
                        <div class="testimonial-carousel-one">
                            ...
                            <div class="item">
                                <div class="testimonial-item text-center">
                                    <div class="testimonial-author">
                                        <div class="author-img">
                                            <img class="img-responsive" src="{{asset('frontend/img/testimonial/3.png')}}" alt="" />
                                        </div>
                                        <h4>John Daniel</h4>
                                        <h6>business man</h6>
                                        <ul>
                    ...
                    <div class="blog-feature">
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item style-1">
                                ...
                                <div class="blog-img"><a href="#"><img src="{{asset('frontend/img/blog/1.jpg')}}" alt=""></a>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item style-1">
                                ...
                                <div class="blog-img"><a href="#"><img src="{{asset('frontend/img/blog/2.jpg')}}" alt=""></a>
                                    <div class="blog-event-date">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 center-block">
                            <div class="blog-item style-1">
                                ...
                                <div class="blog-img"><a href="#"><img src="{{asset('frontend/img/blog/3.jpg')}}" alt=""></a>
                                    <div class="blog-event-date">
                ...
                <div class="row margin-top-30">
                    <div class="col-md-3">
                      <div class="footer-item footer-widget-one">
                          <img alt="" src="{{asset('frontend/img/logo.png')}}" class="footer-logo">
                      ...
                      <div class="footer-item">
                        <div class="footer-item clearfix">
                          ...
                          <div class="flicker-feed gutter">
                            <a href="{{asset('frontend/img/flicker/1.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/1.jpg')}}" alt=""></a>
                            <a href="{{asset('frontend/img/flicker/2.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/2.jpg')}}" alt=""></a>
                            <a href="{{asset('frontend/img/flicker/3.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/3.jpg')}}" alt=""></a>
                            <a href="{{asset('frontend/img/flicker/4.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/4.jpg')}}" alt=""></a>
                            <a href="{{asset('frontend/img/flicker/5.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/5.jpg')}}" alt=""></a>
                            <a href="{{asset('frontend/img/flicker/6.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/6.jpg')}}" alt=""></a>
                            <a href="{{asset('frontend/img/flicker/7.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/7.jpg')}}" alt=""></a>
                            <a href="{{asset('frontend/img/flicker/8.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/8.jpg')}}" alt=""></a>
                            <a href="{{asset('frontend/img/flicker/9.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{asset('frontend/img/flicker/9.jpg')}}" alt=""></a>
                          </div>
                        </div>
                      </div>
                    </div>
